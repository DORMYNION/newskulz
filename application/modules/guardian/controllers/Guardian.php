...
class Guardian extends MY_Controller {
    ...
    * ********************************************************** */
    private function _prepare_guardian_validation() {
        ...
        $this->form_validation->set_rules('name_2', $this->lang->line('name_2'), 'trim');
        $this->form_validation->set_rules('relation_2', $this->lang->line('relation_2'), 'trim');
        $this->form_validation->set_rules('phone_2', $this->lang->line('phone_2'), 'trim');
        $this->form_validation->set_rules('profession_2', $this->lang->line('profession'), 'trim');
        $this->form_validation->set_rules('present_address_2', $this->lang->line('present') . ' ' . $this->lang->line('address_2'), 'trim');
        $this->form_validation->set_rules('permanent_address_2', $this->lang->line('permanent') . ' ' . $this->lang->line('address_2'), 'trim');
        $this->form_validation->set_rules('religion_2', $this->lang->line('religion_2'), 'trim');
        $this->form_validation->set_rules('other_info_2', $this->lang->line('other_info_2'), 'trim');
    }
    ...
    * ********************************************************** */
    private function _get_posted_guardian_data() {
        ...
        $items[] = 'phone_2';
        $items[] = 'profession_2';
        $items[] = 'present_address_2';
        $items[] = 'permanent_address_2';
        $items[] = 'religion_2';
        $items[] = 'other_info_2';
        ...
        if ($_FILES['photo_2']['name_2']) {
            $data['photo_2'] = $this->_upload_photo();
        }
