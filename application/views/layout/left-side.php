    ...
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="<?php echo site_url('dashboard'); ?>" class="site_title_">
                ...
                <span style="font-size: small;"><?php echo($this->session->userdata('school_name')); ?></span>
                <img class="logo" src="<?php echo UPLOAD_PATH; ?>/logo/<?php echo $this->session->userdata('school_logo') ?>" width='60'>
            </a>
        </div>
